...
class Xml extends Service
{
    ...
    /**
     * Validate the DOM Document against a specified XSD schema file.
     * @param string $s_path            The path to the schema file, on-system.
     * @param int [optional] $flags     The flags to apply to the validation process.
     * @return boolean
     */
    public function schemaValidate($s_path, $flags = null)
    {
        return $this->dom_document->schemaValidate($s_path, $flags);
    }
}
