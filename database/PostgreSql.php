 ...
 *       
 */
class PostgreSql extends \youconix\core\database\GeneralDAL
{
    ...
    {
        $this->connectionEnd();
        $this->connection($this->connectionData->username, $this->connectionData->password, $s_database, $this->connectionData->host, $this->connectionData->port);
    }
