...
abstract class AbstractTemplate {
   ...
   */
  public function __construct(\youconix\Core\Services\FileHandler $handler, \ConfigInterface $config, \youconix\Core\Routes $routes) {
  ...
  {
    return [
      'template loaded' => $this->s_file,
      'template directory' => $this->s_templateDir
    ];
  }
