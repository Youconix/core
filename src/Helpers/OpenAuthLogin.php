...
class OpenAuthLogin extends Helper
{
    ...
    public function editScreen()
    {
      ...
      <tr>
        <td>Active</td>
        <td>Type</td>
        <td>SettingsInterface seperated with a ,</td>
      </tr>
      </thead>
      <tbody>
      ';
       ...
       <td><input type="text" id="openid_settings_' . $i . '" value="' . $a_setting['SettingsInterface'] . '" onblur="openIDSave(' . $i . ')"></td> 
     </tr>';
    ...
    {
        $a_settings = $this->getSettingsArray($a_setting['SettingsInterface']);
