 ...
 */
class Group extends \youconix\Core\ORM\AbstractRepository
{
  /**
   *
   * @var \ConfigInterface
   ...
   */
  public function __construct(\EntityManager $manager, \BuilderInterface $builder, \youconix\Core\Entities\Group $group)
  {
