...
class Login_Normal extends \youconix\core\models\LoginParent
{
     ...
     */
    public function __construct(\Cookie $cookie, \Builder $builder, \LoggerInterface $logs, \youconix\core\services\Hashing $hashing, \Session $session, \youconix\core\services\Mailer $mailer, \youconix\core\services\Random $random, \Headers $headers, \ConfigInterface $config, \youconix\core\models\User $user)
    {
