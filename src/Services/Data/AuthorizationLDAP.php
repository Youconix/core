...
class AuthorizationLDAP extends \youconix\core\services\data\AuthorizationNormal
{
    ...
    public function __construct(\youconix\core\services\LDAP $service_LDAP, \Builder $builder, \LoggerInterface $service_Logs, \youconix\core\models\User $model_User, \youconix\core\models\PM $model_PM)
    {
