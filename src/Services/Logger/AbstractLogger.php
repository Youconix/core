 ...
 * @since 2.0
 */
abstract class AbstractLogger extends \youconix\Core\Services\AbstractService implements \LoggerInterface
{
    ...
    public function __construct(\youconix\core\services\Mailer $mailer, \ConfigInterface $config, \Psr\Log\LogLevel $loglevel)
    {
